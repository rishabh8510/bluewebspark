...
const FoundersSection = () => {
  return (
    <section className="w-full mt-20 md:mt-40 px-4">
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-8 md:gap-12">
        {/* Left Content */}
        <div className="w-full ml-2 md:ml-4 text-white text-center md:text-left border-t border-b border-r border-[#4B5E7A] rounded-tr-lg rounded-br-lg p-6 md:p-8">
          <div className="ml-40">
        ...
        {/* Right Cards */}
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:pr-28">
          {/* Manish Card */}
          <div
            className="relative w-full bg-cover bg-center rounded-xl h-60 sm:h-64 md:h-72 overflow-hidden"
